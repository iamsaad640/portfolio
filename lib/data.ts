...
export const personalInfo = {
  ...
  socials: {
    ...
    fiverr: "https://www.fiverr.com/saad_solves",
    upwork: "https://www.upwork.com/freelancers/saadsolves",
  },
...
export const testimonials = [
  // Fiverr Reviews
  {
    id: 1,
    content:
      "Saad is always fast to respond, his English communication skills are exceptional, he is efficient, has great attention to detail, has excellent website improvement suggestions & has helped me greatly. Takes the stress out of doing it all myself. I know I can trust the job will be done in a reasonable time.",
    author: "breezer37",
    country: "Australia",
  ...
  },
  {
    id: 4,
    content:
      "Working with Saad was great. He is very knowledgeable about his craft and very easy to talk to and easy to work with. We are making great progress. Will be working with him again.",
    author: "Lisa Bowe",
    country: "Caribbean",
    platform: "upwork" as const,
    rating: 5,
  },
  {
    id: 5,
    content:
      "Saad is the website King! His English is amazing, second to none. I would highly recommend Saad to work on any website design, changes, coaching & I'm sure there's many other talents he has! Thank you Saad",
    author: "breezer37",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 6,
    content:
      "Saad answered all of my questions about Wordpress website development. I had been very confused on what to do, who to hire, how it works, but Saad cleared up all these questions for me on a Zoom call and now I feel like I understand the process a lot better. I really appreciate your help, thank you!",
    author: "embee7",
    country: "United States",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 7,
    content:
      "Saad is exceptional at doing work on websites & providing training on how you can edit your own website. He provides value for money, is fair in his pricing, does work quickly, is contactable frequently & communicates well. I will use Saad every time. Glad I found him!",
    author: "breezer37",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 8,
    content:
      "Saad was very easy to work with. The work was on time and everything was done to a high standard. I will use him again. Thank you for saving the day!",
    author: "renewedl",
  ...
  },
  {
    id: 9,
    content:
      "It was great to work with Saad for the second time. We achieved everything we set out to do. The training helped me a lot. I will definitely push on his button again for training in future.",
    author: "theotheunissen",
  ...
  },
  {
    id: 11,
    content:
      "Saad is a lifesaver! The spec was followed exactly and he is very responsive. Thank you!",
    author: "renewedl",
    country: "United Kingdom",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 12,
    content:
      "Amazing experience — Saad helped me to understand and solve all my related Wordpress issues. Highly recommended seller on Fiverr.",
    author: "reshmamohamm801",
  ...
  },
  {
    id: 13,
    content:
      "It was great being trained & guided by Saad. He communicates very well, and was able to explain my requirements. Going to book the longer session with him next week.",
    author: "theotheunissen",
    country: "South Africa",
    platform: "fiverr" as const,
    rating: 5,
  ...
  },
  {
    id: 16,
    content:
      "Saad is excellent at teaching you what you need to learn to update your website & very efficient in updating it for you! Thank you Saad",
    author: "breezer37",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 17,
    content:
      "He is very responsive and has clear communication skills, he helped me to fix my website.",
    author: "vanessamedley",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 18,
    content:
      "Responsive freelancer, skillful in helping me with my elementor project. Thanks!",
    author: "gary500r",
    country: "United States",
    platform: "fiverr" as const,
    rating: 5,
  ...
  {
    id: 20,
    content: "I am very happy with my delivery service, recommended.",
    author: "vanessamedley",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 21,
    content:
      "Saad is amazing — can do anything on your website! 5 stars",
    author: "breezer37",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 22,
    content:
      "Saad helped me so much again. Will definitely press on his button again in future.",
    author: "theotheunissen",
    country: "South Africa",
    platform: "fiverr" as const,
    rating: 5,
  ...
  {
    id: 23,
    content: "Saad is patient and we had great communication!",
    author: "jovanmilosev541",
    country: "Sweden",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 24,
    content: "Very thorough and knowledgeable.",
    author: "maddogxx5",
    country: "United States",
    platform: "fiverr" as const,
    rating: 5,
  ...
  {
    id: 27,
    content: "Excellent gig",
    author: "abdellahmatar",
    country: "France",
    platform: "fiverr" as const,
    rating: 5,
  },
  {
    id: 28,
    content:
      "I am happy with the service, and this is the third time I have contacted him. The training was excellent and met all my expectations.",
    author: "vanessamedley",
    country: "Australia",
    platform: "fiverr" as const,
    rating: 4.3,
  ...
  },
  {
    id: 30,
    content:
      "He was great to help with some small tweaking but I needed very advanced woocommerce specialist. I didn't realise that my template was so complicated.",
    author: "neringa_mc",
    country: "Ireland",
    platform: "fiverr" as const,
    rating: 4.3,
